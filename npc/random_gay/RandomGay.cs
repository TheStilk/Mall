...
@export var min_max_interpolation: Vector2 = Vector2(0.0, 0.9)
@export var foot_height_offset: float = 0.2
...
@onready var ik_left = $Armature001/Skeleton3D/SkeletonIK_left_foot #gets the skeletonIK bones
@onready var ik_right = $Armature001/Skeleton3D/SkeletonIK_right_foot
@onready var no_raycast_pos_l = $no_raycast_pos_l #gets the 
@onready var no_raycast_pos_r = $no_raycast_pos_r

#physical_skeleton
@onready var skeleton = $Armature001/Skeleton3D
